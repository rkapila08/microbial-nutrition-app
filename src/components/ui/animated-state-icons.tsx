  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        animate={
          done ? { pathLength: 1, opacity: 1 } : { pathLength: 0, opacity: 0 }
        }
  ...
  return (
    ...
    >
      <motion.line
        ...
        strokeLinecap="round"
        animate={
          open ? { y1: 20, y2: 20, rotate: 45 } : { y1: 12, y2: 12, rotate: 0 }
        }
      ...
      <motion.line
        ...
        strokeLinecap="round"
        animate={
          open ? { y1: 20, y2: 20, rotate: -45 } : { y1: 28, y2: 28, rotate: 0 }
        }
        transition={{ duration: 0.35, ease: [0.32, 0.72, 0, 1] }}
        style={{ transformOrigin: "20px 20px" }}
      />
  ...
  return (
    ...
    >
      ...
      <motion.circle
        ...
        fill={color}
        animate={
          unlocked ? { scale: 0.6, opacity: 0.4 } : { scale: 1, opacity: 1 }
        }
  ...
  return (
    ...
    >
      ...
      <motion.circle
        ...
        fill="#EF4444"
        animate={
          notif ? { scale: [0, 1.3, 1], opacity: 1 } : { scale: 0, opacity: 0 }
        }
        transition={{ duration: 0.4, ease: [0.32, 0.72, 0, 1] }}
      />
    </motion.svg>
  ...
  return (
    ...
    >
      <motion.rect
        ...
        rx="7"
        animate={
          on ? { fill: color, opacity: 0.2 } : { fill: color, opacity: 0.08 }
        }
        transition={{ duration: 0.3 }}
      />
      <rect
  ...
  return (
    ...
    >
      ...
      <motion.circle
        ...
        strokeWidth={2}
        animate={
          hidden ? { scale: 0.6, opacity: 0.2 } : { scale: 1, opacity: 1 }
        }
        transition={{ duration: 0.3 }}
      />
      <motion.line
    ...
    <div className="w-full max-w-3xl mx-auto px-4 py-16">
      <div className="text-center mb-14">
        ...
        <p className="text-sm text-muted-foreground max-w-md mx-auto">
          12 icons that morph between two meaningful states on loop —
          loading→success, play→pause, lock→unlock. Each tells a micro-story.
        </p>
      </div>
